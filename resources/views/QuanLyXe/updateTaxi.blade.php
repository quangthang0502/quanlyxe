...
@section('content')
    <form action="{{route('capNhapTaxi',$taxi->licenceNumber)}}" method="post" style="padding: 5px">
        ...
        <div class="form-group">
            ...
            <input type="text" name="frameNumber" class="form-control" id="frameNumber" value="{{$taxi->frameNumber}}">
        </div>
        <div class="form-group">
            <label for="machineNumber">Số máy:</label>
            <input type="text" name="machineNumber" class="form-control" id="machineNumber" value="{{$taxi->machineNumber}}">
        </div>
